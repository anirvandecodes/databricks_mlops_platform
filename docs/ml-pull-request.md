...
Opening a pull request will trigger a[workflow](../.github/workflows/databricks_mlops_platform-run-tests.yml) 
...
The model training notebook uses these Feature Store tables as inputs to train, validate and register a new model version in UC.
