...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-databricks_mlops_platform-experiment",
    label="MLflow experiment name",
)

# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.databricks_mlops_platform.databricks_mlops_platform-model", label="Full (Three-Level) Model Name"
)
...
dbutils.widgets.text(
    ...
    "dev.databricks_mlops_platform.trip_dropoff_features",
